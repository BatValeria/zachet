...
queue = []
heapq.heappush(queue, (cost[start[0]][start[1]], start))
...
# Определяем функцию для вычисления пути минимальной стоимости с использованием алгоритма Дейкстры
while queue:
...
# Определяем функцию для поиска пути минимальной стоимости
